...
For example, if I use the =describe-variable= function to view the definition of the =gc-cons-threshold=
...
check out my [[https://justinlime.dev/p/emacs-crash-course/][other guide here]]. 
...
In this example, we will use Catpuccin, but you can find some others [[https://emacsthemes.com/][here]]. 
